---
name: eas-workflows
description: "EAS service (płatny). Pisanie i rozumienie plików YAML EAS Workflows w projektach Expo. Używaj przy 'CI/CD dla Expo', 'workflow EAS', '.eas/workflows', build pipelines, automatyzacji deploymentu."
