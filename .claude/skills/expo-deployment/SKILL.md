...
description: "Deployment aplikacji Expo do iOS App Store, Google Play, web hosting przez EAS Submit. Używaj przy 'wypuść aplikację', 'submit do App Store', 'release na Google Play', 'deploy mobile'."
version: 1.0.0
license: MIT
---
