...
description: "Networking i data fetching w Expo — fetch API, React Query, SWR, error handling, caching, offline-first, Expo Router data loaders (`useLoaderData`). Używaj przy KAŻDYM requesto API, hooku z fetchem, cache'owaniu, debugowaniu sieci, mobile data layer."
version: 1.0.0
license: MIT
---
