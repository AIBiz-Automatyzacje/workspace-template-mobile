...
description: "`@expo/ui/jetpack-compose` — natywne komponenty Android (Jetpack Compose) bezpośrednio w React Native (SDK 55+). Używaj gdy potrzebujesz native feel na Androidzie (haptyki, dark mode platformy, Material You). UWAGA: vendor lock — wyjście z Expo wymaga przepisania."
---
