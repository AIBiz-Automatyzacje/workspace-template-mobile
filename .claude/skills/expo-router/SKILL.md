---
name: expo-router
description: "Framework (OSS). Nawigacja i routing w Expo Router. File-based routes, grupy i dynamic routes, organizacja folderów, Link z preview i context menu, natywny Stack, tytuły stron, modale i form sheets, NativeTabs, headery i toolbary, header search bar. Używaj przy nawigacji, strukturze tras, tabach, modalach, 'jak zrobić routing w Expo'."
version: 1.0.1
license: MIT
---
