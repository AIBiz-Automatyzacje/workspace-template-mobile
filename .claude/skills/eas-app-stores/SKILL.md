---
name: eas-app-stores
description: "EAS service (płatny). Deploy aplikacji Expo do sklepów przez EAS — build i submit do iOS App Store / Google Play / TestFlight, profile build i submit w eas.json, wersje i build numbers, metadata sklepowa i ASO. Używaj przy 'wypuść aplikację', 'submit do App Store', 'release na Google Play', 'eas build', 'eas submit', bump wersji. Deploy strony web / API routes → skill eas-hosting."
version: 1.0.0
license: MIT
---
