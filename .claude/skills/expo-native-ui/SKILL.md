---
name: expo-native-ui
description: "Framework (OSS). Budowa pięknych, natywnie wyglądających ekranów Expo. Apple HIG styling, semantic colors, natywne kontrolki, SF Symbols, media, animacje, visual effects, gradienty, storage, responsive layout. Używaj przy budowie ekranów React Native, 'zrób mobilne UI', 'ekran Expo', 'native feel'. Routing i nawigacja → skill expo-router."
version: 1.1.1
license: MIT
---
