---
name: expo-use-dom
description: "DOM Components — uruchamianie web kodu (recharts, react-syntax-highlighter, dowolna React web lib) w webview na natywie, as-is na webie. Inkrementalna migracja kodu web → native. Używaj przy 'web library w mobile', 'reuse komponentu webowego'."
version: 1.0.0
license: MIT
---
