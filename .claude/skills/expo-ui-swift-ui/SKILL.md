...
description: "`@expo/ui/swift-ui` — natywne komponenty iOS (SwiftUI) bezpośrednio w React Native (SDK 55+). Używaj gdy potrzebujesz native feel na iOS (haptyki, dynamic type, native pickers, Liquid Glass). UWAGA: vendor lock — wyjście z Expo wymaga przepisania."
---
