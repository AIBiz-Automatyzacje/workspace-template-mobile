---
name: expo-dom
description: "Framework (OSS). DOM Components — uruchamianie web kodu (dowolna React web lib) w webview na natywie, as-is na webie. Inkrementalna migracja kodu web → native. Używaj przy 'web library w mobile', 'reuse komponentu webowego'. Pełna migracja całej apki web → skill expo-web-to-native (upstream expo/skills, nie zaimportowany)."
version: 1.0.0
license: MIT
---
