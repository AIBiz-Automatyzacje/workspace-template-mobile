...
description: "YAML pipeline EAS w `.eas/workflows/` — build, submit, deployment automation. Używaj przy 'CI/CD dla Expo', 'workflow EAS', '.eas/workflows', automatyzacji deploymentu, build pipelines."
