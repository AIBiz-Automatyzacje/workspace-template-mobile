...
- [ ] One-thumb test: czy główne akcje w zasięgu kciuka?
...
14. **Concentric border radius** — outer = inner + padding (eliminuje "off feel")
...
*Skill universal pod każdą aplikację mobilną. 18 plików w `resources/`, ~6400 linii. Ostatni update: 2026-05-10.*
