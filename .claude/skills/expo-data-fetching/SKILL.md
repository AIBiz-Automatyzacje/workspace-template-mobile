...
description: "Framework (OSS). Używaj przy KAŻDYM requeście sieciowym, wywołaniu API i data fetchingu — implementacja i debugowanie. Fetch API, React Query, SWR, error handling, caching, offline support, Expo Router data loaders (`useLoaderData`)."
version: 1.0.0
license: MIT
---
