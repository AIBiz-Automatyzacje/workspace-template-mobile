...
description: Framework (OSS). Struktura folderów NOWEJ aplikacji Expo (Expo Router). Używaj przy scaffoldingu/layoutcie nowego projektu Expo albo decyzji, gdzie ma żyć plik. TYLKO dla nowych projektów — nigdy nie restrukturyzuj istniejącej apki pod ten układ.
version: 1.0.0
license: MIT
---
