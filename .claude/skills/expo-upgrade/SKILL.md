---
name: expo-upgrade
description: "Framework (OSS). Upgrade SDK Expo krok po kroku, breaking changes, fixowanie dependency issues. Używaj przy 'zaktualizuj Expo', 'migracja na nowy SDK', 'New Architecture'."
version: 1.0.0
license: MIT
---
